...
const Login = () => {
  ...
  const login = async (e) => {
    ...
    try {
      const result = await ApiCallPost("/auth/admin-panel-login", {
  ...
  return (
    <>
      <div
        className={`${styles.container} px-1 px-md-1 px-lg-2 px-xl-4 py-4 mx-auto`}
      >
        <div className={`card mb-4 ${styles.card0}`}>
          <div className={`card-body ${styles.card__body}`}>
            <div className={`${styles.row} row ml-5 h-100`}>
              <div className="d-none d-md-flex col-md-4 col-sm-4 col-lg-6 h-100">
                <ImgSlider></ImgSlider>
              </div>

              <div className="col-md-8 col-lg-6 col-sm-6 col-sm-11 col-12 h-100">
                <div
                  className={`login d-flex align-items-center h-100 ${styles.login} `}
                >
