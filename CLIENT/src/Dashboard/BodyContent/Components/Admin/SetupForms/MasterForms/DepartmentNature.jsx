...
const DepartmentNature = () => {
    ...
    useEffect(() => {
        ...
        const fetchData = async () => {
            try {
                var result = await ApiCallGet('/Get_dept_nature');
                console.log(result);
    ...
    const handleformSubmit = async (e) => {
        ...
        console.log(value);
        var result = await ApiCallPost("/insertdeptnature", { nat_desc: value });
        if (result.error) {
    ...
    const update = async (oldRow, newRow) => {
        ...
        if (newRow.cat_desc === '' || newRow.cat_desc === null || newRow.cat_desc === undefined) {
            validate = false;
            Toast("Department Nature Cannot be empty", "error");
        }
            ...
            <div className="w-100" style={{ display: 'flex', flexDirection: 'column' }}>
                ...
                <form style={{ display: 'flex', alignItems: 'center', justifyContent: 'center', marginTop: '2rem', marginBottom: '5rem', position: 'relative', width: '100%' }}>
                    <div className="row w-100" style={{ alignItems: 'center', justifyContent: 'center' }}>
                        ...
                        <div className={`col-lg-6 col-md-6 col-sm-16 col-6  pb-3 ${guidelines.inputclass}`}  >
                            <TextField fullWidth
                                required
...
export default DepartmentNature;