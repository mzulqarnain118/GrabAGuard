...
const DepartmentType = () => {
    ...
    useEffect(() => {
        ...
        const fetchData = async () => {
            try {
                var result = await ApiCallGet('/Get_dept_type');
                console.log(result);
    ...
    const handleformSubmit = async (e) => {
        ...
        var result = await ApiCallPost("/insertdepttype", { type_name: value });
    ...
    const update = async (oldRow, newRow) => {
        ...
        let validate = true;
        if (newRow.type_name === '' || newRow.type_name === null || newRow.type_name === undefined) {
            validate = false;
