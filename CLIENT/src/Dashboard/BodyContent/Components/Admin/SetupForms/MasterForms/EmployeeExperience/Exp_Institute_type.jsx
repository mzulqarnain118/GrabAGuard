...
const Exp_Institute_Type = (props) => {
    ...
    const handleformSubmit = async (e) => {
        ...
        var result1 = await ApiCallPost("/Insert_exp_institute_type", { inst_type_desc: values });
        if (result1.error) {
...
export default Exp_Institute_Type;