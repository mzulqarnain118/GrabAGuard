...
const SelectionForm = (props) => {
    ...
    useEffect(() => {
        const fetchData = async () => {
            ...
            if (!userData.rowData.asNewRecord && props.submitAction === 'Update') {
                let result2 = await ApiCallPost('/get_emp_desig_selections', { desig_serial: userData.rowData.serial_no });
                if (result2.error) {

                    Toast('Data Could Not be Fetched', 'error')
                }
                else {
                    console.log('dtaaa', result2.data)
    ...
    const addSelectionDetail = () => {
        if (selectionType === '') {
            ...
            const newSelection = {
                ...
                emp_desig_serial: userData.rowData.serial_no,
    ...
    const submitData = async () => {
        ...
        const CurdateFormated = currentDate => currentDate.getFullYear() + '-' + (parseInt(currentDate.getMonth()) + 1) + '-' + currentDate.getDate();
        console.log(userData.rowData.campus_id);
        var screenData = {
            emp_id: props.id,
            ...
            campus_id: parseInt(userData.rowData.campus_id),
                ...
                <Stack>
                    ...
                    <MatTable
                        ...
                        onRowClick={(event, rowData) => {
                            console.log('ya ha data', rowData);
                            rowClick(rowData)
                    ...
                    <div className='row'>
                        ...
                        <div className={`${guidelines.inputclass}`} style={{ marginTop: '10px' }} >
