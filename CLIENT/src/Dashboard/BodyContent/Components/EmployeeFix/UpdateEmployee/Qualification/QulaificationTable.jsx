...
const QualificationTable = (props) => {
    ...
    const columns = [
      ...
      {
        title: "updateCompanyNumber",
        field: "updateCompanyNumber",
        type: "string",
        editable: () => false,
        cellStyle: { textAlign: "left" },
        headerStyle: { textAlign: "left" },
      ...
      {
        title: "updateHourlyRate",
        field: "updateHourlyRate",
        type: "string",
        editable: () => false,
        cellStyle: { textAlign: "left" },
        headerStyle: { textAlign: "left" },
      ...
      {
        title: "updatePreviousWork",
        field: "updatePreviousWork",
        type: "string",
        editable: () => false,
        cellStyle: { textAlign: "left" },
        headerStyle: { textAlign: "left" },
      ...
      {
        title: "updateLatitude",
        field: "updateLatitude",
        type: "string",
        editable: () => false,
        cellStyle: { textAlign: "left" },
        headerStyle: { textAlign: "left" },
      ...
      {
        title: "updateLongitude",
        field: "updateLongitude",
        type: "string",
        editable: () => false,
        cellStyle: { textAlign: "left" },
        headerStyle: { textAlign: "left" },
